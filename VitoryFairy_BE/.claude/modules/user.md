...
## 책임
JWT 기반 인증/인가 + 회원 탈퇴. signup·login·refresh·logout·withdraw. **포트 8080.**
...
- 라이브러리: Security, JPA, Validation, BCrypt, MySQL, dotenv. JJWT는 web-support가 전이 제공(user 자체 의존 없음)

...
class GameLineupTest {
    ...
    void builder_withStartingBatter_keepsOrderPositionAndStarterFlag() {
        ...
        // when
        Position center = Position.builder().name("중견수").build();
        ...
        assertThat(lineup.getPosition().getName()).isEqualTo("중견수");
    ...
    void builder_withReliefPitcher_keepsDecisionWithoutBatOrder() {
        ...
        GameLineup lineup = GameLineup.builder()
                ...
                .team(home)
                .player(pitcher)
                .position(Position.builder().name("투수").build())
                .isStarter(false)
                .decision("W")
                .build();
        ...
        assertThat(lineup.getPosition().getName()).isEqualTo("투수");

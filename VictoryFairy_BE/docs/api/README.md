...
| 계정 | [account.md](account.md) | user | `/api/users` | 5 | 필수 | 2026-08-20 | [🔗](https://app.notion.com/p/3b278fa9b0f981f8b5bcf163fc897b12) |
...
| 퀴즈 | [quiz.md](quiz.md) | quiz | `/rt/quizzes` | 5 | 필수 | 2026-08-20 | [🔗](https://app.notion.com/p/3b578fa9b0f981c4b09bd8752fb22711) |
...
**총 35개 엔드포인트.** 도메인 이름은 코드의 패키지 구조(`com.skhynix.user.<domain>`, `com.skhynix.quiz.<domain>`)와 1:1로 대응한다 — 새 도메인 패키지가 생기면 이 디렉터리에도 같은 이름의 문서가 하나 생긴다.

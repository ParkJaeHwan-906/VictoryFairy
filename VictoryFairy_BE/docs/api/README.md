...
> 최종 업데이트: 2026-08-08 — **quiz 도메인 신설**: `GET /rt/quizzes/today`(오늘의 퀴즈 목록, 인증 필수, 정답 미포함) 추가. (직전: 2026-08-06 `POST /api/support/players`에 활성 응원 선수 4명 상한(`SUPPORT_PLAYER_LIMIT_EXCEEDED`) 도입 + `GET /api/users/me` 응답에 `supportPlayers`(현재 응원 중인 선수 목록) 추가.)
...
|---|---|---|---|---|---|---|---|
| 인증 | [auth.md](auth.md) | user | `/api/auth` | 9 | 전부 불필요 | 2026-08-04 | [🔗](https://app.notion.com/p/3b278fa9b0f981b39166c408778394e9) |
...
| 퀴즈 | [quiz.md](quiz.md) | quiz | `/rt/quizzes` | 1 | 필수 | 2026-08-08 | [🔗](https://app.notion.com/p/3b578fa9b0f981c4b09bd8752fb22711) |

...
/**
 * 내 요약 프로필 응답({@code GET /api/member/users/me}). 노출 키는 정확히 이 4개로 닫혀 있다(USER-ME-13,
 ...
 * @param supportTeam 현재 응원 중인 구단. 없으면 {@code null}(USER-ME-16 안전망)
 * @param point       보유 포인트
 * @param bqScore     누적 획득 점수. {@code users_bq} 행이 없으면 0(USER-ME-19 안전망)
 */
